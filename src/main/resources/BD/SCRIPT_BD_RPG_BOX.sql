...
CREATE TABLE TB_PERMISSAO(
	SQ_PERMISSAO bigserial primary key,
	DS_PERMISSAO varchar(20)
);

CREATE TABLE TB_PERMISSAO_USUARIO(
	SQ_USUARIO bigserial primary key,
	SQ_PERMISSAO bigint,
	CONSTRAINT FK_PERMISSAO_USUARIO_USUARIO FOREIGN KEY(SQ_USUARIO) REFERENCES TB_USUARIO(SQ_USUARIO),
	CONSTRAINT FK_PERMISSAO_USUARIO_PERMISSAO FOREIGN KEY(SQ_PERMISSAO) REFERENCES TB_PERMISSAO(SQ_PERMISSAO)
);